...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="audit-schema",
        description="Audit Perseus TEI documents against a Schematron schema.",
    )
    parser.add_argument("files", nargs="+", type=Path, metavar="FILE")
    parser.add_argument(
        "--schema", type=Path, required=True, metavar="SCH",
        help="Schematron schema file (.sch).",
    )
    parser.add_argument(
